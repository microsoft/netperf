import{j as a,H as r,T as d}from"./index-IEs8D-Cp.js";import{G as p}from"./graph-view-mse-ObvK.js";import{u as l}from"./use-fetch-data-PUh6YWsf.js";import{C as u}from"./Container-rSllO8Jx.js";import{G as c}from"./app-website-visits-3tmIyrh-.js";let i=!1;document.addEventListener("mousedown",function(){i=!0});document.addEventListener("mouseup",function(){i=!1});function b(){const o="https://raw.githubusercontent.com/microsoft/netperf/deploy/detailed_rps_and_latency_page.json",{data:t}=l(o);let s=a.jsx("div",{});if(t){const n=[];for(let e=0;e<t.linuxTcp.data.length;e++)n.push(e+1);s=a.jsx(p,{title:"Requests Per Second - Max out of 3 runs",subheader:"Tested using Windows Server 2022, Linux Ubuntu 20.04.3 LTS",labels:n,map:e=>(i&&(window.location.href=`https://github.com/microsoft/msquic/commit/${t.linuxTcpUploadThroughput[e][2]}`),`<div style = "margin: 10px">
